...
my_barrier:
	...
	.file	2 "/home/hamid.farzaneh/CostModelEvaluationRepo/NewEval/Sel" "dpu/../generated_headers/gen_map.h"
	.file	3 "/home/hamid.farzaneh/CostModelEvaluationRepo/NewEval/Sel" "dpu/../generated_headers/common_structs.h"
	.file	4 "/home/hamid.farzaneh/CostModelEvaluationRepo/NewEval/Sel" "dpu/dpu.c"
	.section	.text.main,"ax",@progbits
	.globl	main                            // -- Begin function main
	.type	main,@function
main:                                   // @main
.Lfunc_begin0:
	.loc	4 23 0                          // dpu/dpu.c:23:0
...
.Ltmp0:
	...
	sd r22, -56, d20
.Ltmp1:
	//DEBUG_VALUE: main:tasklet_id <- $r21
	...
	move r21, id, nz, .LBB0_2
.Ltmp2:
// %bb.1:
	.loc	4 26 5                          // dpu/dpu.c:26:5
	call r23, mem_reset
.Ltmp3:
.LBB0_2:
...
.Ltmp4:
	.loc	4 35 30                         // dpu/dpu.c:35:30
	move r0, DPU_INPUT_ARGUMENTS
.Ltmp5:
	//DEBUG_VALUE: main:ITER_PER_THREAD <- undef
	.loc	4 36 22                         // dpu/dpu.c:36:22
	lw r1, r0, 4
.Ltmp6:
	//DEBUG_VALUE: main:THREADS <- $r1
	.loc	4 37 7                          // dpu/dpu.c:37:7
	jgeu r21, r1, .LBB0_15
.Ltmp7:
// %bb.3:
	//DEBUG_VALUE: main:THREADS <- $r1
	.loc	4 40 27                         // dpu/dpu.c:40:27
...
.Ltmp8:
	...
	lw r20, r0, 8
.Ltmp9:
	//DEBUG_VALUE: main:ITER_PER_THREAD <- $r20
	sw r22, -20, r20
	.loc	4 41 39 is_stmt 1               // dpu/dpu.c:41:39
	lsl r14, r19, 2
.Ltmp10:
...
.Ltmp12:
	...
	.loc	4 44 26                         // dpu/dpu.c:44:26
	move r0, r14
	call r23, mem_alloc
.Ltmp13:
	move r16, r0
.Ltmp14:
	//DEBUG_VALUE: main:cache_OUTPUT <- $r16
	.loc	4 0 26 is_stmt 0                // dpu/dpu.c:0:26
	move r0, 16
	.loc	4 45 25 is_stmt 1               // dpu/dpu.c:45:25
	call r23, mem_alloc
.Ltmp15:
	move r17, r0
.Ltmp16:
	//DEBUG_VALUE: main:cache_COUNT <- $r17
	.loc	4 47 43                         // dpu/dpu.c:47:43
	lw r0, r22, -24
	move r1, r20
.Ltmp17:
	call r23, __mulsi3
.Ltmp18:
	sw r22, -16, r0
.Ltmp19:
	//DEBUG_VALUE: main:mram_base_addr_COUNT <- undef
	//DEBUG_VALUE: main:mram_base_addr_INPUT <- undef
...
.Ltmp21:
	...
	.loc	4 59 42                         // dpu/dpu.c:59:42
	lsl r0, r21, 2
	sw r22, -12, r0
	.loc	4 59 61 is_stmt 0               // dpu/dpu.c:59:61
	move r1, r20
.Ltmp22:
...
.Ltmp24:
	...
	.loc	4 65 71 is_stmt 1               // dpu/dpu.c:65:71
	move r0, r21
	move r1, r18
	call r23, __mulsi3
.Ltmp25:
	.loc	4 0 71 is_stmt 0                // dpu/dpu.c:0:71
	lw r4, r22, -20
.Ltmp26:
	//DEBUG_VALUE: main:ITER_PER_THREAD <- $r4
	lw r3, r22, -24
.Ltmp27:
	//DEBUG_VALUE: main:mram_temp_addr_COUNT <- undef
	//DEBUG_VALUE: main:mram_temp_addr_OUTPUT <- undef
	//DEBUG_VALUE: main:mram_temp_addr_INPUT <- undef
	//DEBUG_VALUE: r <- 0
...
.Ltmp30:
	...
	//DEBUG_VALUE: main:mram_temp_addr_OUTPUT <- undef
	//DEBUG_VALUE: main:mram_temp_addr_INPUT <- undef
	//DEBUG_VALUE: main:mram_base_addr_COUNT <- $r2
	jgtu r18, 1, .LBB0_6
.Ltmp31:
// %bb.5:
	//DEBUG_VALUE: main:arr_el_count <- [DW_OP_constu 16, DW_OP_minus] [$r22+0]
...
.LBB0_6:
	...
	lsl_add r21, r2, r0, 4
.Ltmp33:
	//DEBUG_VALUE: main:mram_temp_addr_COUNT <- $r21
...
// %bb.7:
	...
	add r0, r20, r1
.Ltmp35:
	//DEBUG_VALUE: main:mram_temp_addr_INPUT <- $r0
	move r1, 0
.Ltmp36:
	lsl_add r2, r0, r5, 2
.Ltmp37:
	//DEBUG_VALUE: main:mram_temp_addr_OUTPUT <- $r2
	move r3, r1, true, .LBB0_8
.Ltmp38:
.LBB0_12:                               //   in Loop: Header=BB0_8 Depth=1
	...
	//DEBUG_VALUE: main:cache_INPUT <- $r15
	//DEBUG_VALUE: main:BUFFER_SIZE <- $r14
	//DEBUG_VALUE: count <- $r5
	//DEBUG_VALUE: r <- $r3
	//DEBUG_VALUE: main:mram_temp_addr_OUTPUT <- $r2
	//DEBUG_VALUE: main:mram_temp_addr_INPUT <- $r0
	.loc	4 83 20 is_stmt 1               // dpu/dpu.c:83:20
	sw r17, 0, r5
	move r4, -1
.Ltmp39:
	//DEBUG_VALUE: mram_write:nb_of_bytes <- $r14
	//DEBUG_VALUE: mram_write:from <- $r16
	//DEBUG_VALUE: mram_write:to <- $r2
	...
	lsr_add r4, r4, r14, 3
	lsl_add r4, r16, r4, 24
	sdma r4, r2, 0
.Ltmp40:
	//DEBUG_VALUE: mram_write:nb_of_bytes <- 16
	//DEBUG_VALUE: mram_write:from <- $r17
	//DEBUG_VALUE: mram_write:to <- $r21
	.loc	6 66 24 is_stmt 0               // /opt/upmem/upmem-2025.1.0-Linux-x86_64/bin/../share/upmem/include/syslib/mram.h:66:24
	sdma r17, r21, 1
.Ltmp41:
	.loc	4 90 26 is_stmt 1               // dpu/dpu.c:90:26
	add r0, r0, r14
.Ltmp42:
	//DEBUG_VALUE: main:mram_temp_addr_INPUT <- $r0
	.loc	4 91 27                         // dpu/dpu.c:91:27
	add r2, r2, r14
.Ltmp43:
	//DEBUG_VALUE: main:mram_temp_addr_OUTPUT <- $r2
...
.LBB0_11:                               //   in Loop: Header=BB0_9 Depth=2
	...
	.loc	4 76 23 is_stmt 1               // dpu/dpu.c:76:23
	add r4, r4, 4
	add r6, r6, -1, z, .LBB0_12
.Ltmp50:
.LBB0_9:                                //   Parent Loop BB0_8 Depth=1
	...
	//DEBUG_VALUE: count <- $r5
	//DEBUG_VALUE: c <- undef
	.loc	4 77 17                         // dpu/dpu.c:77:17
	lw r7, r4, 0
.Ltmp51:
	//DEBUG_VALUE: pred:x <- $r7
	//DEBUG_VALUE: value <- $r7
	.file	7 "/home/hamid.farzaneh/CostModelEvaluationRepo/NewEval/Sel" "dpu/../support/pred.h"
	.loc	7 9 48                          // dpu/../support/pred.h:9:48
	and r8, r7, 1, nz, .LBB0_11
.Ltmp52:
// %bb.10:                              //   in Loop: Header=BB0_9 Depth=2
	...
	//DEBUG_VALUE: main:mram_temp_addr_OUTPUT <- $r2
	//DEBUG_VALUE: main:mram_temp_addr_INPUT <- $r0
	.loc	4 79 9                          // dpu/dpu.c:79:9
	lsl_add r8, r16, r5, 2
	.loc	4 79 29 is_stmt 0               // dpu/dpu.c:79:29
	sw r8, 0, r7
	//DEBUG_VALUE: count <- $r5
	.loc	4 80 14 is_stmt 1               // dpu/dpu.c:80:14
	add r5, r5, 1, true, .LBB0_11
.Ltmp53:
.LBB0_13:
	//DEBUG_VALUE: main:arr_el_count <- [DW_OP_constu 16, DW_OP_minus] [$r22+0]
	//DEBUG_VALUE: main:mram_temp_addr_COUNT <- $r21
...
.Ltmp63:
	//DEBUG_VALUE: main:mram_temp_addr_OUTPUT <- undef
	//DEBUG_VALUE: main:mram_temp_addr_INPUT <- undef
	.loc	4 92 26 is_stmt 1               // dpu/dpu.c:92:26
	add r21, r21, 16
.Ltmp64:
	//DEBUG_VALUE: main:mram_temp_addr_COUNT <- $r21
	.loc	4 68 42                         // dpu/dpu.c:68:42
...
.LBB0_15:
	.loc	4 0 3                           // dpu/dpu.c:0:3
	move r0, 0
	.loc	4 96 1 is_stmt 1                // dpu/dpu.c:96:1
	ld d20, r22, -56
	ld d18, r22, -48
	ld d16, r22, -40
	ld d14, r22, -32
...
.Lfunc_end0:
	...
	.cfi_endproc
	.file	8 "/opt/upmem/upmem-2025.1.0-Linux-x86_64/bin/../share/upmem/include/syslib" "sysdef.h"
...
.Ldebug_info_start0:
	...
	.long	78                              // DW_AT_type
	.byte	0                               // End Of Children Mark
	.byte	17                              // Abbrev [17] 0x192:0x18 DW_TAG_subprogram
	...
	.long	426                             // DW_AT_type
	.byte	1                               // DW_AT_inline
	.byte	16                              // Abbrev [16] 0x19e:0xb DW_TAG_formal_parameter
	.long	.Linfo_string29                 // DW_AT_name
	.byte	7                               // DW_AT_decl_file
	.byte	9                               // DW_AT_decl_line
	.long	433                             // DW_AT_type
	.byte	0                               // End Of Children Mark
	.byte	6                               // Abbrev [6] 0x1aa:0x7 DW_TAG_base_type
	.long	.Linfo_string28                 // DW_AT_name
	.byte	2                               // DW_AT_encoding
	.byte	1                               // DW_AT_byte_size
	.byte	18                              // Abbrev [18] 0x1b1:0x5 DW_TAG_const_type
	.long	67                              // DW_AT_type
	.byte	19                              // Abbrev [19] 0x1b6:0x24f DW_TAG_subprogram
	.long	.Lfunc_begin0                   // DW_AT_low_pc
	.long	.Lfunc_end0-.Lfunc_begin0       // DW_AT_high_pc
	...
	.long	1029                            // DW_AT_type
                                        // DW_AT_external
	.byte	20                              // Abbrev [20] 0x1cb:0xf DW_TAG_variable
	.long	.Ldebug_loc0                    // DW_AT_location
	.long	.Linfo_string32                 // DW_AT_name
	.byte	4                               // DW_AT_decl_file
	.byte	24                              // DW_AT_decl_line
	.long	78                              // DW_AT_type
	.byte	20                              // Abbrev [20] 0x1da:0xf DW_TAG_variable
	.long	.Ldebug_loc1                    // DW_AT_location
	.long	.Linfo_string33                 // DW_AT_name
	.byte	4                               // DW_AT_decl_file
	.byte	35                              // DW_AT_decl_line
	.long	67                              // DW_AT_type
	.byte	20                              // Abbrev [20] 0x1e9:0xf DW_TAG_variable
	.long	.Ldebug_loc2                    // DW_AT_location
	.long	.Linfo_string13                 // DW_AT_name
	.byte	4                               // DW_AT_decl_file
	.byte	36                              // DW_AT_decl_line
	.long	67                              // DW_AT_type
	.byte	20                              // Abbrev [20] 0x1f8:0xf DW_TAG_variable
	.long	.Ldebug_loc3                    // DW_AT_location
	.long	.Linfo_string34                 // DW_AT_name
	.byte	4                               // DW_AT_decl_file
	.byte	40                              // DW_AT_decl_line
	.long	67                              // DW_AT_type
	.byte	20                              // Abbrev [20] 0x207:0xf DW_TAG_variable
	.long	.Ldebug_loc4                    // DW_AT_location
	.long	.Linfo_string35                 // DW_AT_name
	.byte	4                               // DW_AT_decl_file
	.byte	41                              // DW_AT_decl_line
	.long	67                              // DW_AT_type
	.byte	20                              // Abbrev [20] 0x216:0xf DW_TAG_variable
	.long	.Ldebug_loc5                    // DW_AT_location
	.long	.Linfo_string36                 // DW_AT_name
	.byte	4                               // DW_AT_decl_file
	.byte	43                              // DW_AT_decl_line
	.long	283                             // DW_AT_type
	.byte	20                              // Abbrev [20] 0x225:0xf DW_TAG_variable
	.long	.Ldebug_loc6                    // DW_AT_location
	.long	.Linfo_string37                 // DW_AT_name
	.byte	4                               // DW_AT_decl_file
	.byte	44                              // DW_AT_decl_line
	.long	283                             // DW_AT_type
	.byte	20                              // Abbrev [20] 0x234:0xf DW_TAG_variable
	.long	.Ldebug_loc7                    // DW_AT_location
	.long	.Linfo_string38                 // DW_AT_name
	.byte	4                               // DW_AT_decl_file
	.byte	45                              // DW_AT_decl_line
	.long	283                             // DW_AT_type
	.byte	20                              // Abbrev [20] 0x243:0xf DW_TAG_variable
	.long	.Ldebug_loc8                    // DW_AT_location
	.long	.Linfo_string39                 // DW_AT_name
	.byte	4                               // DW_AT_decl_file
	.byte	53                              // DW_AT_decl_line
	.long	67                              // DW_AT_type
	.byte	20                              // Abbrev [20] 0x252:0xf DW_TAG_variable
	.long	.Ldebug_loc9                    // DW_AT_location
	.long	.Linfo_string40                 // DW_AT_name
	.byte	4                               // DW_AT_decl_file
	.byte	50                              // DW_AT_decl_line
	.long	67                              // DW_AT_type
	.byte	21                              // Abbrev [21] 0x261:0xb DW_TAG_variable
	.long	.Linfo_string41                 // DW_AT_name
	.byte	4                               // DW_AT_decl_file
	.byte	51                              // DW_AT_decl_line
	.long	67                              // DW_AT_type
	.byte	21                              // Abbrev [21] 0x26c:0xb DW_TAG_variable
	.long	.Linfo_string42                 // DW_AT_name
	.byte	4                               // DW_AT_decl_file
	.byte	48                              // DW_AT_decl_line
	.long	67                              // DW_AT_type
	.byte	20                              // Abbrev [20] 0x277:0xf DW_TAG_variable
	.long	.Ldebug_loc10                   // DW_AT_location
	.long	.Linfo_string43                 // DW_AT_name
	.byte	4                               // DW_AT_decl_file
	.byte	47                              // DW_AT_decl_line
	.long	67                              // DW_AT_type
	.byte	20                              // Abbrev [20] 0x286:0xf DW_TAG_variable
	.long	.Ldebug_loc11                   // DW_AT_location
	.long	.Linfo_string44                 // DW_AT_name
	.byte	4                               // DW_AT_decl_file
	.byte	56                              // DW_AT_decl_line
	.long	67                              // DW_AT_type
	.byte	20                              // Abbrev [20] 0x295:0xf DW_TAG_variable
	.long	.Ldebug_loc12                   // DW_AT_location
	.long	.Linfo_string45                 // DW_AT_name
	.byte	4                               // DW_AT_decl_file
	.byte	60                              // DW_AT_decl_line
	.long	67                              // DW_AT_type
	.byte	20                              // Abbrev [20] 0x2a4:0xf DW_TAG_variable
	.long	.Ldebug_loc13                   // DW_AT_location
	.long	.Linfo_string46                 // DW_AT_name
	.byte	4                               // DW_AT_decl_file
	.byte	58                              // DW_AT_decl_line
	.long	67                              // DW_AT_type
	.byte	20                              // Abbrev [20] 0x2b3:0xf DW_TAG_variable
	.long	.Ldebug_loc14                   // DW_AT_location
	.long	.Linfo_string47                 // DW_AT_name
	.byte	4                               // DW_AT_decl_file
	.byte	64                              // DW_AT_decl_line
	.long	67                              // DW_AT_type
	.byte	22                              // Abbrev [22] 0x2c2:0x10 DW_TAG_inlined_subroutine
	...
	.byte	23                              // Abbrev [23] 0x2d2:0xec DW_TAG_lexical_block
	.long	.Ltmp27                         // DW_AT_low_pc
	.long	.Ltmp67-.Ltmp27                 // DW_AT_high_pc
	.byte	20                              // Abbrev [20] 0x2db:0xf DW_TAG_variable
	.long	.Ldebug_loc15                   // DW_AT_location
	.long	.Linfo_string48                 // DW_AT_name
	.byte	4                               // DW_AT_decl_file
	.byte	68                              // DW_AT_decl_line
	.long	1029                            // DW_AT_type
	.byte	24                              // Abbrev [24] 0x2ea:0xd3 DW_TAG_lexical_block
	.long	.Ldebug_ranges3                 // DW_AT_ranges
	.byte	20                              // Abbrev [20] 0x2ef:0xf DW_TAG_variable
	.long	.Ldebug_loc16                   // DW_AT_location
	.long	.Linfo_string49                 // DW_AT_name
	.byte	4                               // DW_AT_decl_file
	.byte	75                              // DW_AT_decl_line
	.long	67                              // DW_AT_type
	.byte	25                              // Abbrev [25] 0x2fe:0x28 DW_TAG_inlined_subroutine
	.long	318                             // DW_AT_abstract_origin
	.long	.Ldebug_ranges0                 // DW_AT_ranges
	.byte	4                               // DW_AT_call_file
	.byte	85                              // DW_AT_call_line
	.byte	5                               // DW_AT_call_column
	.byte	26                              // Abbrev [26] 0x30a:0x9 DW_TAG_formal_parameter
	.long	.Ldebug_loc18                   // DW_AT_location
	.long	326                             // DW_AT_abstract_origin
	.byte	26                              // Abbrev [26] 0x313:0x9 DW_TAG_formal_parameter
	...
	.byte	0                               // End Of Children Mark
	.byte	25                              // Abbrev [25] 0x326:0x28 DW_TAG_inlined_subroutine
	.long	318                             // DW_AT_abstract_origin
	.long	.Ldebug_ranges1                 // DW_AT_ranges
	.byte	4                               // DW_AT_call_file
	.byte	87                              // DW_AT_call_line
	.byte	5                               // DW_AT_call_column
	.byte	26                              // Abbrev [26] 0x332:0x9 DW_TAG_formal_parameter
	.long	.Ldebug_loc21                   // DW_AT_location
	.long	326                             // DW_AT_abstract_origin
	.byte	26                              // Abbrev [26] 0x33b:0x9 DW_TAG_formal_parameter
	.long	.Ldebug_loc22                   // DW_AT_location
	.long	337                             // DW_AT_abstract_origin
	.byte	26                              // Abbrev [26] 0x344:0x9 DW_TAG_formal_parameter
	.long	.Ldebug_loc20                   // DW_AT_location
	.long	348                             // DW_AT_abstract_origin
	.byte	0                               // End Of Children Mark
	.byte	25                              // Abbrev [25] 0x34e:0x28 DW_TAG_inlined_subroutine
	.long	360                             // DW_AT_abstract_origin
	.long	.Ldebug_ranges2                 // DW_AT_ranges
	.byte	4                               // DW_AT_call_file
	.byte	69                              // DW_AT_call_line
	.byte	5                               // DW_AT_call_column
	.byte	26                              // Abbrev [26] 0x35a:0x9 DW_TAG_formal_parameter
	.long	.Ldebug_loc25                   // DW_AT_location
	.long	368                             // DW_AT_abstract_origin
	.byte	26                              // Abbrev [26] 0x363:0x9 DW_TAG_formal_parameter
	.long	.Ldebug_loc24                   // DW_AT_location
	.long	379                             // DW_AT_abstract_origin
	.byte	26                              // Abbrev [26] 0x36c:0x9 DW_TAG_formal_parameter
	.long	.Ldebug_loc23                   // DW_AT_location
	.long	390                             // DW_AT_abstract_origin
	.byte	0                               // End Of Children Mark
	.byte	23                              // Abbrev [23] 0x376:0x46 DW_TAG_lexical_block
	.long	.Ltmp49                         // DW_AT_low_pc
	.long	.Ltmp53-.Ltmp49                 // DW_AT_high_pc
	.byte	21                              // Abbrev [21] 0x37f:0xb DW_TAG_variable
	.long	.Linfo_string50                 // DW_AT_name
	.byte	4                               // DW_AT_decl_file
	.byte	76                              // DW_AT_decl_line
	.long	1029                            // DW_AT_type
	.byte	23                              // Abbrev [23] 0x38a:0x31 DW_TAG_lexical_block
	.long	.Ltmp50                         // DW_AT_low_pc
	.long	.Ltmp53-.Ltmp50                 // DW_AT_high_pc
	.byte	20                              // Abbrev [20] 0x393:0xf DW_TAG_variable
	.long	.Ldebug_loc26                   // DW_AT_location
	.long	.Linfo_string51                 // DW_AT_name
	.byte	4                               // DW_AT_decl_file
	.byte	77                              // DW_AT_decl_line
	.long	67                              // DW_AT_type
	.byte	27                              // Abbrev [27] 0x3a2:0x18 DW_TAG_inlined_subroutine
	...
	.byte	28                              // Abbrev [28] 0x3b2:0x7 DW_TAG_formal_parameter
	...
	.byte	0                               // End Of Children Mark
	.byte	0                               // End Of Children Mark
	.byte	29                              // Abbrev [29] 0x3be:0x7 DW_TAG_GNU_call_site
	.byte	1                               // DW_AT_GNU_call_site_target
	.byte	103
	.long	.Ltmp3                          // DW_AT_low_pc
	.byte	29                              // Abbrev [29] 0x3c5:0x7 DW_TAG_GNU_call_site
	.byte	1                               // DW_AT_GNU_call_site_target
	.byte	103
	.long	.Ltmp4                          // DW_AT_low_pc
	.byte	29                              // Abbrev [29] 0x3cc:0x7 DW_TAG_GNU_call_site
	.byte	1                               // DW_AT_GNU_call_site_target
	.byte	103
	.long	.Ltmp11                         // DW_AT_low_pc
	.byte	29                              // Abbrev [29] 0x3d3:0x7 DW_TAG_GNU_call_site
	.byte	1                               // DW_AT_GNU_call_site_target
	.byte	103
	.long	.Ltmp13                         // DW_AT_low_pc
	.byte	29                              // Abbrev [29] 0x3da:0x7 DW_TAG_GNU_call_site
	.byte	1                               // DW_AT_GNU_call_site_target
	.byte	103
	.long	.Ltmp15                         // DW_AT_low_pc
	.byte	29                              // Abbrev [29] 0x3e1:0x7 DW_TAG_GNU_call_site
	.byte	1                               // DW_AT_GNU_call_site_target
	.byte	103
	.long	.Ltmp18                         // DW_AT_low_pc
	.byte	29                              // Abbrev [29] 0x3e8:0x7 DW_TAG_GNU_call_site
	.byte	1                               // DW_AT_GNU_call_site_target
	.byte	103
	.long	.Ltmp20                         // DW_AT_low_pc
	.byte	29                              // Abbrev [29] 0x3ef:0x7 DW_TAG_GNU_call_site
	.byte	1                               // DW_AT_GNU_call_site_target
	.byte	103
	.long	.Ltmp23                         // DW_AT_low_pc
	.byte	29                              // Abbrev [29] 0x3f6:0x7 DW_TAG_GNU_call_site
	.byte	1                               // DW_AT_GNU_call_site_target
	.byte	103
	.long	.Ltmp25                         // DW_AT_low_pc
	.byte	29                              // Abbrev [29] 0x3fd:0x7 DW_TAG_GNU_call_site
	.byte	1                               // DW_AT_GNU_call_site_target
	.byte	103
	.long	.Ltmp55                         // DW_AT_low_pc
	.byte	0                               // End Of Children Mark
	.byte	6                               // Abbrev [6] 0x405:0x7 DW_TAG_base_type
...
.Linfo_string2:
	.asciz	"/home/hamid.farzaneh/CostModelEvaluationRepo/NewEval/Sel" // string offset=116
.Linfo_string3:
...
.Linfo_string15:
	.asciz	"dpu_arguments_t"               // string offset=336
.Linfo_string16:
	.asciz	"nb_cycle"                      // string offset=352
.Linfo_string17:
	.asciz	"__atomic_bit_barrier_my_barrier" // string offset=361
.Linfo_string18:
	.asciz	"unsigned char"                 // string offset=393
.Linfo_string19:
	.asciz	"uint8_t"                       // string offset=407
.Linfo_string20:
	.asciz	"me"                            // string offset=415
.Linfo_string21:
	.asciz	"sysname_t"                     // string offset=418
.Linfo_string22:
	.asciz	"mram_write"                    // string offset=428
.Linfo_string23:
	.asciz	"from"                          // string offset=439
.Linfo_string24:
	.asciz	"to"                            // string offset=444
.Linfo_string25:
	.asciz	"nb_of_bytes"                   // string offset=447
.Linfo_string26:
	.asciz	"mram_read"                     // string offset=459
.Linfo_string27:
	.asciz	"pred"                          // string offset=469
.Linfo_string28:
	.asciz	"_Bool"                         // string offset=474
.Linfo_string29:
	.asciz	"x"                             // string offset=480
.Linfo_string30:
	.asciz	"main"                          // string offset=482
.Linfo_string31:
	.asciz	"int"                           // string offset=487
.Linfo_string32:
	.asciz	"tasklet_id"                    // string offset=491
.Linfo_string33:
	.asciz	"ITER_PER_THREAD"               // string offset=502
.Linfo_string34:
	.asciz	"BUFFER_COUNT"                  // string offset=518
.Linfo_string35:
	.asciz	"BUFFER_SIZE"                   // string offset=531
.Linfo_string36:
	.asciz	"cache_INPUT"                   // string offset=543
.Linfo_string37:
	.asciz	"cache_OUTPUT"                  // string offset=555
.Linfo_string38:
	.asciz	"cache_COUNT"                   // string offset=568
.Linfo_string39:
	.asciz	"mram_base_addr_COUNT"          // string offset=580
.Linfo_string40:
	.asciz	"mram_base_addr_INPUT"          // string offset=601
.Linfo_string41:
	.asciz	"mram_base_addr_OUTPUT"         // string offset=622
.Linfo_string42:
	.asciz	"arr_el_size"                   // string offset=644
.Linfo_string43:
	.asciz	"arr_el_count"                  // string offset=656
.Linfo_string44:
	.asciz	"local_iter_count"              // string offset=669
.Linfo_string45:
	.asciz	"mram_temp_addr_OUTPUT"         // string offset=686
.Linfo_string46:
	.asciz	"mram_temp_addr_INPUT"          // string offset=708
.Linfo_string47:
	.asciz	"mram_temp_addr_COUNT"          // string offset=729
.Linfo_string48:
	.asciz	"r"                             // string offset=750
.Linfo_string49:
	.asciz	"count"                         // string offset=752
.Linfo_string50:
	.asciz	"c"                             // string offset=758
.Linfo_string51:
	.asciz	"value"                         // string offset=760
	.addrsig

...
.LBB0_2:                                // =>This Loop Header: Depth=1
	...
	move r3, -1
.Ltmp11:
	//DEBUG_VALUE: mram_write:nb_of_bytes <- $r17
...
.LBB0_3:                                //   Parent Loop BB0_2 Depth=1
	...
	//DEBUG_VALUE: main:cache_C <- $r0
	//DEBUG_VALUE: j <- undef
	.loc	2 65 20                         // ./dpu/task.c:65:20
	lw r5, r14, 0
	.loc	2 65 33 is_stmt 0               // ./dpu/task.c:65:33
	lw r6, r3, 0
	.loc	2 65 31                         // ./dpu/task.c:65:31
	add r5, r6, r5
	.loc	2 65 18                         // ./dpu/task.c:65:18
	sw r0, 0, r5
.Ltmp14:
	//DEBUG_VALUE: j <- [DW_OP_plus_uconst 1, DW_OP_stack_value] undef
	.loc	2 64 23 is_stmt 1               // ./dpu/task.c:64:23
	add r3, r3, 4
	add r4, r4, -1, nz, .LBB0_3
.Ltmp15:
// %bb.4:                               //   in Loop: Header=BB0_2 Depth=1
	...
	//DEBUG_VALUE: x <- $r2
	//DEBUG_VALUE: main:cache_C <- $r0
	.loc	2 62 30                         // ./dpu/task.c:62:30
	add r2, r2, 1
.Ltmp16:
	//DEBUG_VALUE: x <- $r2
	.loc	2 62 3 is_stmt 0                // ./dpu/task.c:62:3
	jneq r2, r18, .LBB0_2
.Ltmp17:
.LBB0_5:
	//DEBUG_VALUE: main:ITER <- $r18
...
.Ldebug_info_start0:
	...
	.byte	17                              // Abbrev [17] 0x19d:0x7 DW_TAG_formal_parameter
	.byte	1                               // DW_AT_location
	.byte	94
	.long	182                             // DW_AT_abstract_origin
	.byte	18                              // Abbrev [18] 0x1a4:0x9 DW_TAG_formal_parameter
	.long	.Ldebug_loc6                    // DW_AT_location
	.long	193                             // DW_AT_abstract_origin
	.byte	17                              // Abbrev [17] 0x1ad:0x7 DW_TAG_formal_parameter
	.byte	1                               // DW_AT_location
	.byte	97
...
.Linfo_string13:
	.asciz	"mram_write"                    // string offset=277
.Linfo_string14:
	.asciz	"from"                          // string offset=288
.Linfo_string15:
	.asciz	"to"                            // string offset=293
.Linfo_string16:
	.asciz	"nb_of_bytes"                   // string offset=296
.Linfo_string17:
	.asciz	"main"                          // string offset=308
.Linfo_string18:
	.asciz	"int"                           // string offset=313
.Linfo_string19:
	.asciz	"mram_base_addr_B"              // string offset=317
.Linfo_string20:
	.asciz	"cache_A"                       // string offset=334
.Linfo_string21:
	.asciz	"cache_B"                       // string offset=342
.Linfo_string22:
	.asciz	"b_offset"                      // string offset=350
.Linfo_string23:
	.asciz	"cache_C"                       // string offset=359
.Linfo_string24:
	.asciz	"x"                             // string offset=367
.Linfo_string25:
	.asciz	"j"                             // string offset=369
.Linfo_string26:
	.asciz	"mram_base_addr_A"              // string offset=371
.Linfo_string27:
	.asciz	"a_offset"                      // string offset=388
	.addrsig

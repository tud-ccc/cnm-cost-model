...
def createCommonStructs(thread_dims, iter_dims, buffer_sizes, generated_dir=None):
...
def createConfigurationHeader(
    ...
    createCommonStructs(thread_dims, iter_dims, buffer_sizes, generated_dir=generated_dir)

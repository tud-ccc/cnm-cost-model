...
from kernels.Hst_xdsl import TestOp
...
# Path B of the comparison started for VectorOp/ReduceOp/Scan: same real
# hardware measurements (hst_file), same Simulator, but predicted from
# kernels/Hst_xdsl.py's hand-transcribed CnmGen/output/llvcnm/hst.llvcnm
# instruction list instead of Hst.py's hand-transcribed real assembly.
_OUTPUT_FILE = Path(__file__).resolve().parent / "output" / "hst_comparison_xdsl.csv"
